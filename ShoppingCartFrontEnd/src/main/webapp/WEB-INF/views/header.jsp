...
<li class="dropdown">
        <a id ="z" class="dropdown-toggle" data-toggle="dropdown" href="#">Electronics
...
<li class="dropdown">
        <a id ="z" class="dropdown-toggle" data-toggle="dropdown" href="#">Appliances
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
...
<li class="dropdown">
        <a id ="z" class="dropdown-toggle" data-toggle="dropdown" href="#">Men
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
...
<li class="dropdown">
        <a id ="z" class="dropdown-toggle" data-toggle="dropdown" href="#">Women
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
		<li><a href ="#">Footwear</a></li>
<li><a href ="#">Clothing</a></li>
...
<li><a id ="su" href = "signuppage.htm"><span class="glyphicon glyphicon-user" id ="sug"></span>Sign Up</a></li>
...
<div class="row">
  <div class="col-sm-8">
    <div class="input-group">
      <input id ="e" type="text" class="form-control SearchBar" placeholder="Search for..anything">
